    ...
    <section className={styles.section}>
      <div className="container">
        <Reveal>
          ...
          <div style={{ backgroundColor: 'rgba(241, 245, 249, 0.8)', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '14px 20px', margin: '0 auto 2.5rem auto', maxWidth: '850px', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            <h3 style={{ margin: 0, color: 'var(--color-text)', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1rem' }}>
              <span style={{ fontSize: '1.15rem' }}>🏢</span> Note for Businesses & Factories
            </h3>
            ...
            <div style={{ marginTop: '4px' }}>
              <Link href="/for-businesses" style={{ color: 'var(--color-primary)', fontWeight: 600, fontSize: '0.9rem', textDecoration: 'underline' }}>View B2B Services &rarr;</Link>
            </div>
          </div>
        </Reveal>
